...
LRESULT WINAPI EsgiWindowProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam ) 
{
	...
	*/
		...
		case WM_LBUTTONDOWN:
			esgiMouseFunc(ESGI_LEFT_BUTTON, ESGI_DOWN, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
		break;
		case WM_LBUTTONUP:
			esgiMouseFunc(ESGI_LEFT_BUTTON, ESGI_DOWN, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
		break;
		case WM_RBUTTONDOWN:
			esgiMouseFunc(ESGI_RIGHT_BUTTON, ESGI_DOWN, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
		break;
		case WM_RBUTTONUP:
			esgiMouseFunc(ESGI_RIGHT_BUTTON, ESGI_UP, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
		break;
		case WM_MBUTTONDOWN:
			esgiMouseFunc(ESGI_MIDDLE_BUTTON, ESGI_DOWN, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
		break;
		case WM_MBUTTONUP:
			esgiMouseFunc(ESGI_MIDDLE_BUTTON, ESGI_UP, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
		break;
